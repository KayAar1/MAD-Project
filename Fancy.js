...
const kidsDresses = [
  { id: '1', image: require('./assets/fancy1.jpg'), price: 2500, name: 'White Night' },
  { id: '2', image: require('./assets/fancy2.jpg'), price: 3000, name: 'Pink Evening' },
  { id: '3', image: require('./assets/fancy3.jpg'), price: 2500, name: 'Grape Green' },
  { id: '4', image: require('./assets/fancy4.jpg'), price: 3000, name: 'Purple Patch' },
  { id: '5', image: require('./assets/fancy5.jpg'), price: 2500, name: 'Orange Mayoun' },
  { id: '6', image: require('./assets/fancy6.jpg'), price: 3000, name: 'Green Sharara' },
  { id: '7', image: require('./assets/fancy7.jpg'), price: 2500, name: 'Freshers Night' },
  { id: '8', image: require('./assets/fancy8.jpg'), price: 3000, name: 'Farewell Night' },
  { id: '9', image: require('./assets/fancy9.jpg'), price: 2500, name: 'Shaam Mexi' },
  { id: '10', image: require('./assets/fancy10.jpg'), price: 3000, name: 'Qawali Night' },
];
...
export default function KidsCategories() {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Women Fancy Outfits</Text>
      <FlatList
        data={kidsDresses}
