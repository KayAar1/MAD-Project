...
const kidsDresses = [
    { id: '1', image: require('./assets/casual1.jpg'), price: 2500, name: 'Peach' },
    { id: '2', image: require('./assets/casual2.jpg'), price: 3000, name: 'Purple' },
    { id: '3', image: require('./assets/casual3.jpg'), price: 3500, name: 'Red' },
    { id: '4', image: require('./assets/casual4.jpg'), price: 4000, name: 'Green' },
    { id: '5', image: require('./assets/casual5.jpg'), price: 4500, name: 'Dual Colored' },
    { id: '6', image: require('./assets/casual6.jpg'), price: 5000, name: 'Pink' },
    { id: '7', image: require('./assets/casual7.jpg'), price: 3500, name: 'White Shirt' },
    { id: '8', image: require('./assets/casual8.jpg'), price: 4000, name: 'Shades Of Pink' },
    { id: '9', image: require('./assets/casual9.jpg'), price: 4500, name: 'Blue' },
    { id: '10',image: require('./assets/casual10.jpg'), price: 5000, name: 'Grape Green' },
  ];
...
export default function KidsCategories() {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Women Casual Outfits</Text>
      <FlatList
        data={kidsDresses}
